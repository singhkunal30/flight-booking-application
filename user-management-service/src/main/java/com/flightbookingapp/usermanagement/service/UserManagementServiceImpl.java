	...
	public UserDTO register(UserDTO userDTO) {
		try {
			userManagementRepository.findByEmail(userDTO.getEmail()).ifPresent(existingUser -> {
	            throw new CommonException(errMsg.getUserAlreadyExist() + " " + userDTO.getEmail(),
			...
			throw new CommonException(e.getMessage(), errCode.getInvalidRequest() , HttpStatus.BAD_REQUEST);
		}
	}
